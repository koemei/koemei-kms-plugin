 ...
 * @ignore
 */
class Kms_Kb_DocCommentParser
{
    const DOCCOMMENT_READONLY = "/\\@readonly/i";
    const DOCCOMMENT_IGNORE = "/\\@ignore/i";
    ...
    const DOCCOMMENT_VIEWHOOK = "/\\@viewhook (.*)/i";
    ...
    {
        $this->ignore = preg_match( self::DOCCOMMENT_IGNORE, $comment);
        ...
        if (preg_match_all(self::DOCCOMMENT_VIEWHOOK, $comment, $result))
        {

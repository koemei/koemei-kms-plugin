 ...
 * @subpackage Client
 */
class Kaltura_Client_Type_AssetPropertiesCompareCondition extends Kaltura_Client_Type_Condition
{
	...
	public function __construct(SimpleXMLElement $xml = null)
	{
		...
		if(empty($xml->properties))
			...
			$this->properties = Kaltura_Client_Client::unmarshalItem($xml->properties);
	}
	/**

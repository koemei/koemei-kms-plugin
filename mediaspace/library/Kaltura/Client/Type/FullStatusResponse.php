 ...
 * @subpackage Client
 */
class Kaltura_Client_Type_FullStatusResponse extends Kaltura_Client_ObjectBase
{
	...
	public function __construct(SimpleXMLElement $xml = null)
	{
		...
		if(empty($xml->schedulers))
			$this->schedulers = array();
		else
			$this->schedulers = Kaltura_Client_Client::unmarshalItem($xml->schedulers);
	}
	/**

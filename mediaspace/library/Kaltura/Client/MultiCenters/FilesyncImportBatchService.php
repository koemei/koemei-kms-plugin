...
class Kaltura_Client_MultiCenters_FilesyncImportBatchService extends Kaltura_Client_ServiceBase
{
	...
	{
		$kparams = array();
		$this->client->queueServiceActionCall("multicenters_filesyncimportbatch", "updatePartnerLoadTable", $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$resultObject = $this->client->doQueue();
		$this->client->throwExceptionIfError($resultObject);
	...
	{
		$kparams = array();
		$this->client->queueServiceActionCall("multicenters_filesyncimportbatch", "suspendJobs", $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$resultObject = $this->client->doQueue();
		$this->client->throwExceptionIfError($resultObject);

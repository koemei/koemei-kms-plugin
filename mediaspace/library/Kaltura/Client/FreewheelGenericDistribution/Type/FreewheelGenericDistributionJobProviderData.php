 ...
 * @subpackage Client
 */
class Kaltura_Client_FreewheelGenericDistribution_Type_FreewheelGenericDistributionJobProviderData extends Kaltura_Client_ContentDistribution_Type_ConfigurableDistributionJobProviderData
{
	...
	public function __construct(SimpleXMLElement $xml = null)
	{
		...
		if(empty($xml->cuePoints))
			...
			$this->cuePoints = Kaltura_Client_Client::unmarshalItem($xml->cuePoints);
	}
	/**

 ...
 * @subpackage Client
 */
class Kaltura_Client_AvnDistribution_AvnService extends Kaltura_Client_ServiceBase
{
	...
	function getFeed($distributionProfileId, $hash)
	{
		...
		$this->client->queueServiceActionCall("avndistribution_avn", "getFeed", $kparams);

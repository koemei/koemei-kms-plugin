 ...
 * @subpackage Client
 */
class Kaltura_Client_HttpNotification_Type_HttpNotificationObjectField extends Kaltura_Client_Type_EvalStringField
{
	public function getKalturaObjectType()
	{
		return 'KalturaHttpNotificationObjectField';
	}

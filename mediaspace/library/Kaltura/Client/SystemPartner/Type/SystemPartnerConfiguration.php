...
class Kaltura_Client_SystemPartner_Type_SystemPartnerConfiguration extends Kaltura_Client_ObjectBase
{
	...
	public function __construct(SimpleXMLElement $xml = null)
	{
		...
		if(!empty($xml->autoModerateEntryFilter))
			$this->autoModerateEntryFilter = Kaltura_Client_Client::unmarshalItem($xml->autoModerateEntryFilter);
		...
		if(empty($xml->disabledDeliveryTypes))
			...
			$this->disabledDeliveryTypes = Kaltura_Client_Client::unmarshalItem($xml->disabledDeliveryTypes);

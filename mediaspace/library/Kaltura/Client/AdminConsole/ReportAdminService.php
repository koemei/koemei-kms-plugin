 ...
 * @subpackage Client
 */
class Kaltura_Client_AdminConsole_ReportAdminService extends Kaltura_Client_ServiceBase
{
	...
	function add(Kaltura_Client_Type_Report $report)
	{
		$kparams = array();
	...
	function listAction(Kaltura_Client_Type_ReportFilter $filter = null, Kaltura_Client_Type_FilterPager $pager = null)
	{
		$kparams = array();
		if ($filter !== null)
	...
	function update($id, Kaltura_Client_Type_Report $report)
	{
		$kparams = array();
		$this->client->addParam($kparams, "id", $id);
		$this->client->addParam($kparams, "report", $report->toParams());

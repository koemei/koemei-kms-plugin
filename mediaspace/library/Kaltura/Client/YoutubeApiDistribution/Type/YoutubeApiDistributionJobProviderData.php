 ...
 * @subpackage Client
 */
class Kaltura_Client_YoutubeApiDistribution_Type_YoutubeApiDistributionJobProviderData extends Kaltura_Client_ContentDistribution_Type_ConfigurableDistributionJobProviderData
{
	...
	public function __construct(SimpleXMLElement $xml = null)
	{
		...
		if(empty($xml->captionsInfo))
			...
			$this->captionsInfo = Kaltura_Client_Client::unmarshalItem($xml->captionsInfo);
	}
	/**
	 * 
	 *

...
class Kaltura_Client_ContentDistribution_ContentDistributionBatchService extends Kaltura_Client_ServiceBase
{
	...
	function updatePartnerLoadTable()
	{
		$kparams = array();
		$this->client->queueServiceActionCall("contentdistribution_contentdistributionbatch", "updatePartnerLoadTable", $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$resultObject = $this->client->doQueue();
		$this->client->throwExceptionIfError($resultObject);
	...
	{
		$kparams = array();
		$this->client->queueServiceActionCall("contentdistribution_contentdistributionbatch", "suspendJobs", $kparams);
		if ($this->client->isMultiRequest())
			return $this->client->getMultiRequestResult();
		$resultObject = $this->client->doQueue();
		$this->client->throwExceptionIfError($resultObject);
